...
/**
 * Port for retrieving download configuration.
 * Implementations can load from properties files, database, or other sources.
 */
public interface TournamentFileDownloadConfigPort {
